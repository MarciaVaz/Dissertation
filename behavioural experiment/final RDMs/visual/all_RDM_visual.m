...
estimated_rdm = load ('estimate_RDM_ltv_visual.mat');  
...
figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Vision final RDM');caxis([0 0.0227]);
save('final_RDM_visual','rdm');
