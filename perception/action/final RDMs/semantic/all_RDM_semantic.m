...
estimated_rdm = load ('estimate_RDM_ltv_semantic.mat');  
comparisons = estimated_rdm.estimate_RDM_ltv;
...
figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Semantic final RDM');caxis([0 0.0227]);
save('final_RDM_semantic','rdm');