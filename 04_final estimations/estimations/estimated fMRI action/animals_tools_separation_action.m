...
RDMs_euclidean_vector_action_all = NaN(15,4186); % all RDM
RDMs_euclidean_vector_action_animals = NaN(15,1035); % RDM with only animals
RDMs_euclidean_vector_action_tools = NaN(15,1035); % RDM with only tools
RDMs_euclidean_vector_action_mix = NaN(15,1035); % RDM with comparisons across category
...
%         saveas(gcf,[ num2str(0) num2str(each_ROI) '_final_ROI_action_animals.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(0) num2str(each_ROI) '_final_ROI_action_animals.png']] ;
        saveas(gcf,imgName) ; 
    else
%         saveas(gcf,[ num2str(each_ROI) '_final_ROI_action_animals.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(each_ROI) '_final_ROI_action_animals.png']] ;
        saveas(gcf,imgName) ; 
    end 
    close(g)
...
%         saveas(gcf,[ num2str(0) num2str(each_ROI) '_final_ROI_action_tools.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(0) num2str(each_ROI) '_final_ROI_action_tools.png']] ;
        saveas(gcf,imgName) ; 
    else
%         saveas(gcf,[ num2str(each_ROI) '_final_ROI_action_tools.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(each_ROI) '_final_ROI_action_tools.png']] ;
        saveas(gcf,imgName) ; 
    end 
    close(f)
...
%         saveas(gcf,[ num2str(0) num2str(each_ROI) '_final_ROI_action_mix.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(0) num2str(each_ROI) '_final_ROI_action_mix.png']] ;
        saveas(gcf,imgName) ;
    else
%         saveas(gcf,[ num2str(each_ROI) '_final_ROI_action_mix.png']);
        imgName = ['C:\Users\Márcia Vaz\Documents\GitHub\Dissertation\04_final estimations\final estimations (animals and tools separation)\',[ num2str(each_ROI) '_final_ROI_action_mix.png']] ;
        saveas(gcf,imgName) ;
    end 
    close(h)
