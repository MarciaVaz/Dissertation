...
file_names = file_names(1:15)
 ...
 for each_mask=1:numel(file_names)
    ...
    max_val=0.0227
    if each_mask == 1
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_1_RDM_action','rdm');
    elseif each_mask == 2
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_2_RDM_action','rdm');
    elseif each_mask == 3
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_3_RDM_action','rdm');
    elseif each_mask == 4
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_4_RDM_action','rdm');
    elseif each_mask == 5
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_5_RDM_action','rdm');
    elseif each_mask == 6
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_6_RDM_action','rdm');
    elseif each_mask == 7
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_7_RDM_action','rdm');
    elseif each_mask == 8
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_8_RDM_action','rdm');
    elseif each_mask == 9
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_9_RDM_action','rdm');
    elseif each_mask == 10
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_10_RDM_action','rdm');
    elseif each_mask == 11
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_11_RDM_action','rdm');
    elseif each_mask == 12
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_12_RDM_action','rdm');
    elseif each_mask == 13
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_13_RDM_action','rdm');
    elseif each_mask == 14
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_14_RDM_action','rdm');
    else    
        figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action final RDM');caxis([0 max_val]);
        save('final_Mask_15_RDM_action','rdm');
        end
 end
