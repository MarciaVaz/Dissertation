...
for each_mask = 1:15
    for participant = 1:20    
        ...
        max_behav = 0.0227;
        scaled_rdm_action = (rdm*max_behav)/max_rdm;
        
        max_rdm_figure = 0.009;
...
%           figure('units','normalized','WindowState','maximized'); image(scaled_rdm_action,'CDataMapping','scaled');C = colorbar;title('scaled Semantic partial RDM');caxis([0 max_rdm_figure]);
%         end
        ...
        for row = 1:91
            for col = row+1:92
                ...
                if isnan(rdm(row,col)) == 1
                    ...
                    partials_RDM_A (1,c,participant) = scaled_rdm_action(row,col);
                end
...
%         
        if each_mask == 1
            save 01_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 2
            save 02_Mask_partials_RDM_A_scaled partials_RDM_A
       	elseif each_mask == 3
            save 03_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 4
            save 04_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 5
            save 05_Mask_partials_RDM_A_scaled partials_RDM_A
       	elseif each_mask == 6
            save 06_Mask_partials_RDM_A_scaled partials_RDM_A  
        elseif each_mask == 7
            save 07_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 8
            save 08_Mask_partials_RDM_A_scaled partials_RDM_A
       	elseif each_mask == 9
            save 09_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 10
            save 10_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 11
            save 11_Mask_partials_RDM_A_scaled partials_RDM_A
       	elseif each_mask == 12
            save 12_Mask_partials_RDM_A_scaled partials_RDM_A 
        elseif each_mask == 13
            save 13_Mask_partials_RDM_A_scaled partials_RDM_A
        elseif each_mask == 14
            save 14_Mask_partials_RDM_A_scaled partials_RDM_A
        else    
            save 15_Mask_partials_RDM_A_scaled partials_RDM_A
        end
...
save all_partial_RDMs_Action_scaled RDM_Action
...
for each_mask = 1:15
    for participant = 1:20    
        ...
        % I want max to be 0.0227 to correspond to behaviour data
        max_behav = 0.0227;
        scaled_rdm_semantic = (rdm*max_behav)/max_rdm;
        
        max_rdm_figure = 0.009;
        
        % get the partial RDMs for mask 1 for each participant: Action
%         if each_mask == 1
%         	figure(); image(rdm,'CDataMapping','scaled');C = colorbar;title('Action partial RDM');caxis([0 max_rdm_figure]);
%         	figure('units','normalized','WindowState','maximized'); image(scaled_rdm_semantic,'CDataMapping','scaled');C = colorbar;title('Action partial RDM');caxis([0 max_rdm_figure]);
%         end
        ...
        for row = 1:91
            for col = row+1:92
                ...
                if isnan(rdm(row,col)) == 1
                    ...
                    partials_RDM_S (1,c,participant) = scaled_rdm_semantic(row,col);
                end
        ...
        if each_mask == 1
            save 01_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 2
            save 02_Mask_partials_RDM_S_scaled partials_RDM_S
       	elseif each_mask == 3
            save 03_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 4
            save 04_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 5
            save 05_Mask_partials_RDM_S_scaled partials_RDM_S
       	elseif each_mask == 6
            save 06_Mask_partials_RDM_S_scaled partials_RDM_S  
        elseif each_mask == 7
            save 07_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 8
            save 08_Mask_partials_RDM_S_scaled partials_RDM_S
       	elseif each_mask == 9
            save 09_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 10
            save 10_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 11
            save 11_Mask_partials_RDM_S_scaled partials_RDM_S
       	elseif each_mask == 12
            save 12_Mask_partials_RDM_S_scaled partials_RDM_S 
        elseif each_mask == 13
            save 13_Mask_partials_RDM_S_scaled partials_RDM_S
        elseif each_mask == 14
            save 14_Mask_partials_RDM_S_scaled partials_RDM_S
        else    
            save 15_Mask_partials_RDM_S_scaled partials_RDM_S
        end
    % save the RDM for each participant for each Mask
...
save all_partial_RDMs_Semantic_scaled RDM_Semantic