...
% % all
% b1(1).EdgeColor = [0 0.4470 0.7410];
% b2(1).EdgeColor = [0.9137 0.5059 0.1216];
% b3(1).EdgeColor = [0.4660 0.6740 0.1880];
% b1(1).FaceColor = [0.5020 0.7255 0.8706];
% b2(1).FaceColor = [0.9373 0.7529 0.5608];
% b3(1).FaceColor = [0.7333 0.8392 0.5961];
