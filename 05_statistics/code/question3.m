...
title(['Spearman Correlation between fMRI (Action task) and Behaviour RDMs (stimuli: all)']);saveas(gcf,'q3_spearman_correlation_action.png')

figure('units','normalized','WindowState','maximized'); [r,p] = corrplot(semantic_behav_RDMs,'Tail','right','Type','Spearman');
title(['Spearman Correlation between fMRI (Semantic task) and Behaviour RDMs (stimuli: all)']);saveas(gcf,'q3_spearman_correlation_semantic.png')
...
title(['Spearman Correlation between fMRI (Action task) and Behaviour RDMs (stimuli: animals)']);saveas(gcf,'q3_spearman_correlation_action_animals.png')

figure('units','normalized','WindowState','maximized'); [r,p] = corrplot(semantic_behav_RDMs_animals,'Tail','right','Type','Spearman');
title(['Spearman Correlation between fMRI (Semantic task) and Behaviour RDMs (stimuli: animals)']);saveas(gcf,'q3_spearman_correlation_semantic_animals.png')
...
title(['Spearman Correlation between fMRI (Action task) and Behaviour RDMs (stimuli: tools)']);saveas(gcf,'q3_spearman_correlation_action_tools.png')
figure('units','normalized','WindowState','maximized'); [r,p] = corrplot(semantic_behav_RDMs_tools,'Tail','right','Type','Spearman');
title(['Spearman Correlation between fMRI (Semantic task) and Behaviour RDMs (stimuli: tools)']);saveas(gcf,'q3_spearman_correlation_semantic_tools.png')
