...
RDMs_euclidean_estimation_semantic_animals = NaN(15,1035);
RDMs_euclidean_estimation_semantic_tools = NaN(15,1035);
...
%     figure(); image(rdm_semantic_tools,'CDataMapping','scaled');C = colorbar;caxis([0 0.0227]);
    ...
    if each_mask==1
        RDMs_euclidean_estimation_semantic_animals=rdm_vector_animals;
        RDMs_euclidean_estimation_semantic_tools=rdm_vector_tools;
    else
        RDMs_euclidean_estimation_semantic_animals=cat(1,RDMs_euclidean_estimation_semantic_animals,rdm_vector_animals);
        RDMs_euclidean_estimation_semantic_tools=cat(1,RDMs_euclidean_estimation_semantic_tools,rdm_vector_tools);
    end
...
RDMs_euclidean_estimation_semantic_animals
RDMs_euclidean_estimation_semantic_tools

save RDMs_euclidean_estimation_semantic_animals RDMs_euclidean_estimation_semantic_animals
save RDMs_euclidean_estimation_semantic_tools RDMs_euclidean_estimation_semantic_tools
